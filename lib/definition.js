...
cons.types.string = function string(char_range) {
  ...
  function write (stream, value) {
    ...
    stream.write(char_size, [].slice.call(value).map(function(item) {
        return item.charCodeAt(0) % char_range
    }))
  } 
